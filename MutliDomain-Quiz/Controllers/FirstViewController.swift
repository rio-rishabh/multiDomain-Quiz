...
class FirstViewController: UIViewController {
    ...
    var quizBrain_1 = QuizBrain_1()
    
    
    @IBAction func answerButtonPressed(_ sender: UIButton) {
        let userAnswer = sender.currentTitle!
        
        let userCorrectAnswer = quizBrain_1.checkAnswer(userAnswer)
    ...
    @objc func updateUI(){
        questionLabel.text = quizBrain_1.getQuestionText()
        
        let answerChoice = quizBrain_1.getAnswerChoice()
        scoreLabel.text = "Score: \(quizBrain_1.getScore())"
